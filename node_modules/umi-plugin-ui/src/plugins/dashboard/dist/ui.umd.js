(function (global, factory) {
  ...
  (global = global || self, global.dashboard = factory(global.React, global.antd, global.reactDom));
}(this, function (React, antd, reactDom) { 'use strict';
  ...
  */
  ...
  var Masonry = isBrowser ? window.Masonry || masonry : null;
  var imagesloaded$1 = isBrowser ? imagesloaded : null;
  ...
  var renderAvatar = function renderAvatar(item) {
    ...
    if (React__default.isValidElement(icon)) {
      return React__default.createElement(antd.Avatar, Object.assign({}, commonAvatarProps, {
        icon: icon
      }));
    }
    ...
    if (isPlainObject_1(icon)) {
      return React__default.createElement(antd.Avatar, Object.assign({}, commonAvatarProps, icon));
    } // 默认返回 title 第一个字符
    ...
    if (defaultChar) {
      return React__default.createElement(antd.Avatar, Object.assign({}, commonAvatarProps), defaultChar);
    }
  };
  var MESSAGES = {
  ...
  var DashboardUI = function DashboardUI(props) {
    ...
    var _React$useContext = React__default.useContext(UIContext),
    ...
    var containerCls = classnames(styles['container-row'], 'ant-row', 'ant-row-flex');
    ...
    var renderCard = function renderCard(content) {
      ...
      if (Array.isArray(content)) {
        ...
        return React__default.createElement(antd.Row, {
          ...
          type: "flex"
        }, React__default.Children.map(content, function (child, i) {
      ...
      if (React__default.isValidElement(content)) {
        return React__default.cloneElement(content, childProps);
      }
    };
    ...
    if (loading) {
      return React__default.createElement(antd.Spin, null);
    }

    var defaultSpan = api.mini ? DEFAULT_SPAN_MINI : DEFAULT_SPAN;
    var colCls = classnames(actionCardCls, styles['container-col']);
    return React__default.createElement("div", {
      className: styles.container
    }, React__default.createElement(lib, {
      className: containerCls
    }, React__default.createElement(antd.Col, Object.assign({
      className: colCls
    }, defaultSpan), React__default.createElement(antd.Card, {
      className: welcomeCardCls,
      bordered: false,
      hoverable: false
    }, React__default.createElement("h2", null, "Hi"), React__default.createElement("p", null, intl({
      ...
      var _card$title = card.title,
          ...
          right = card.right;
      var Title = React__default.createElement(antd.Row, {
        ...
        className: styles['main-col']
      }, React__default.createElement("div", {
        className: classnames(styles.icon)
      }, renderAvatar(card, api.mini)), React__default.createElement("div", {
        className: styles.info
      }, React__default.createElement("h4", null, title), description && React__default.createElement("p", null, description))), right && React__default.createElement("div", {
        className: styles.right
      }, right));
      var colSpan = api._.isPlainObject(span) ? _objectSpread2({}, defaultSpan, {}, span) : {
        span: span
      };
      return React__default.createElement(antd.Col, Object.assign({
        key: key,
        className: colCls
      }, colSpan), React__default.createElement(antd.Card, {
        title: Title,
  ...
  var lib_2 = lib$1.presetPrimaryColors;
  var lib_3 = lib$1.presetPalettes;
  var lib_4 = lib$1.red;
  var lib_5 = lib$1.volcano;
  var lib_6 = lib$1.gold;
  var lib_7 = lib$1.orange;
  var lib_8 = lib$1.yellow;
  var lib_9 = lib$1.lime;
  var lib_10 = lib$1.green;
  var lib_11 = lib$1.cyan;
  var lib_12 = lib$1.blue;
  var lib_13 = lib$1.geekblue;
  var lib_14 = lib$1.purple;
  var lib_15 = lib$1.magenta;
  var lib_16 = lib$1.grey;
  ...
  var Icon = function Icon(props) {
    ...
    var classString = classnames('anticon', _defineProperty$4({}, "anticon-".concat(icon.name), Boolean(icon.name)), className);
  ...
  var Setting$1 = function Setting(props, ref) {
    ...
    var handleOnChange = function handleOnChange(key, checked) {
      var result;
      return regeneratorRuntime.async(function handleOnChange$(_context) {
        while (1) {
    ...
    var drawerCls = classnames(className, styles$1.drawer);
    return React.createElement(antd.Drawer, Object.assign({
      className: drawerCls,
      visible: visible,
      onClose: closeDrawer,
      title: api.intl({
    ...
    }, restConfig), React.createElement(antd.List, {
      dataSource: cards || [],
      loading: !cards,
      ...
      renderItem: function renderItem(item) {
        return React.createElement(antd.List.Item, {
          ...
          extra: React.createElement(antd.Switch, {
            style: {
              marginLeft: 8
            },
            size: "small",
  ...
  var SettingDrawer = React.forwardRef(Setting$1);

  var useDrawer = (function (config) {
    ...
    var _React$useState = React__default.useState(initVisible),
        _React$useState2 = _slicedToArray(_React$useState, 2),
  ...
  var ConfigAction = function ConfigAction(props) {
    ...
    var handleLaunchEditor = function handleLaunchEditor() {
      launchEditor({
        type: 'project'
      });
    };
    ...
    return React.createElement(React.Fragment, null, !mini && React.createElement(antd.Button, {
    ...
    }, React.createElement(Setting, null)), React.createElement(SettingDrawer, {
      ref: drawerRef
    }));
  };
  ...
  function isDraftable(value) {
    ...
    return isPlainObject$1(value) || !!value[DRAFTABLE] || !!value.constructor[DRAFTABLE] || isMap$1(value) || isSet$1(value);
  }
  ...
  var ownKeys$3 = typeof Reflect !== "undefined" && Reflect.ownKeys ? Reflect.ownKeys : typeof Object.getOwnPropertySymbols !== "undefined" ? function (obj) { return Object.getOwnPropertyNames(obj).concat(Object.getOwnPropertySymbols(obj)); } : Object.getOwnPropertyNames;
  ...
  function each(obj, iter) {
    if (Array.isArray(obj) || isMap$1(obj) || isSet$1(obj)) {
      obj.forEach(function (entry, index) { return iter(index, entry, obj); });
    } else {
      ownKeys$3(obj).forEach(function (key) { return iter(key, obj[key], obj); });
    }
  }
  ...
  function has$2(thing, prop) {
    return isMap$1(thing) ? thing.has(prop) : Object.prototype.hasOwnProperty.call(thing, prop);
  }
  function get(thing, prop) {
    return isMap$1(thing) ? thing.get(prop) : thing[prop];
  }
  function is(x, y) {
  ...
  function clone(obj) {
    ...
    if (isMap$1(obj)) { return new Map(obj); }
    if (isSet$1(obj)) { return new Set(obj); }
  ...
  function createProxy(base, parent) {
    ...
    var state = {
      ...
      // es5 only
      finalized: false,
      assigned: isMap$1(base) ? new Map() : {},
      parent: parent,
      base: base,
      draft: draft,
      drafts: isSet$1(base) ? new Map() : null,
      copy: null,
      revoke: revoke$1,
  ...
  function markChangesSweep(drafts) {
    ...
    for (var i = drafts.length - 1; i >= 0; i--) {
      ...
      if (!state.modified) {
        ...
        } else if (isMap$1(state.base)) {
          if (hasMapChanges(state)) { markChanged(state); }
        } else if (isSet$1(state.base)) {
  ...
  function hasObjectChanges(state) {
    ...
    for (var i = keys.length - 1; i >= 0; i--) {
      ...
      if (baseValue === undefined && !has$2(base, key)) {
        return true;
  ...
  function markChanged$1(state) {
    if (!state.modified) {
      ...
      if (isSet$1(base)) {
        ...
        if (isMap$1(base)) { assignMap(copy, drafts); }else { assign$1(copy, drafts); }
        state.drafts = null;
      }
  ...
  function generatePatches(state, basePath, patches, inversePatches) {
    var generatePatchesFn = Array.isArray(state.base) ? generateArrayPatches : isSet$1(state.base) ? generateSetPatches : generatePatchesFromAssigned;
  ...
  function generatePatchesFromAssigned(state, basePath, patches, inversePatches) {
    ...
    each(state.assigned, function (key, assignedValue) {
      ...
      var op = !assignedValue ? "remove" : has$2(base, key) ? "replace" : "add";
    ...
    for (var i$1 = 0, list = patches; i$1 < list.length; i$1 += 1) {
      ...
      switch (op) {
        ...
        case "add":
          ...
          Array.isArray(base) ? base.splice(key, 0, value) : isMap$1(base) ? base.set(key, value) : isSet$1(base) ? base.add(value) : base[key] = value;
          break;

        case "remove":
          Array.isArray(base) ? base.splice(key, 1) : isMap$1(base) ? base.delete(key) : isSet$1(base) ? base.delete(patch.value) : delete base[key];
          break;
  ...
  Immer.prototype.finalize = function finalize (draft, path, scope) {
    ...
    if (!state.finalized) {
      ...
      if (this.onDelete && !isSet$1(state.base)) {
        ...
        if (this.useProxies) {
          ...
          each(base, function (prop) {
            if (!has$2(copy, prop)) { this$1.onDelete(state, prop); }
          });
        }
      }
  ...
  Immer.prototype.finalizeTree = function finalizeTree (root, rootPath, scope) {
    ...
    var finalizeProperty = function (prop, value, parent) {
      ...
      var isSetMember = isSet$1(parent);

      if (isDraft(value)) {
        var path = isDraftProp && needPatches && !isSetMember && // Set objects are atomic since they have no keys.
        !has$2(state.assigned, prop) // Skip deep patches for assigned keys.
  ...
  var Layout = function Layout(props) {
    ...
    var cards = (api.getDashboard() || []).map(function (card) {
      ...
      return _objectSpread2({}, card, {
        enable: enable
      });
    }); // 根据开启顺序，排列展示顺序

    var dashboardCards = produce(cards, function (draft) {
  ...
  var isDocumentVisible_1 = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  ...
  unwrapExports(isDocumentVisible_1);

  var isOnline_1 = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  function isOnline() {
  ...
  const is_document_visible_1 = __importDefault(isDocumentVisible_1);
  const is_online_1 = __importDefault(isOnline_1);
  // Cache
  ...
  var config_1 = config.cacheGet;
  var config_2 = config.cacheSet;
  var config_3 = config.cacheClear;
  var config_4 = config.CONCURRENT_PROMISES;
  var config_5 = config.CONCURRENT_PROMISES_TS;
  var config_6 = config.FOCUS_REVALIDATORS;
  var config_7 = config.CACHE_REVALIDATORS;
  var config_8 = config.MUTATION_TS;

  var swrConfigContext = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", { value: true });

  const SWRConfigContext = React__default.createContext({});
  SWRConfigContext.displayName = 'SWRConfigContext';
  exports.default = SWRConfigContext;
  });

  unwrapExports(swrConfigContext);

  var useHydration_1 = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  ...
  unwrapExports(hash_1);

  var useSwr = createCommonjsModule(function (module, exports) {
  var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
      return (mod && mod.__esModule) ? mod : { "default": mod };
  };
  ...
  const config_1 = __importStar(config);
  const swr_config_context_1 = __importDefault(swrConfigContext);
  const is_document_visible_1 = __importDefault(isDocumentVisible_1);
  const use_hydration_1 = __importDefault(useHydration_1);
  const hash_1$1 = __importDefault(hash_1);
  ...
  const trigger = (_key, shouldRevalidate = true) => {
      ...
      if (key && updaters) {
          const currentData = config_1.cacheGet(key);
          const currentError = config_1.cacheGet(getErrorKey(key));
  ...
  function useSWR(...args) {
      ...
      config = Object.assign({}, config_1.default, React__default.useContext(swr_config_context_1.default), config);
      ...
      const shouldReadCache = config.suspense || !use_hydration_1.default();
      // stale: get from cache
      let [data, setData] = React__default.useState(shouldReadCache ? config_1.cacheGet(key) : undefined);
      let [error, setError] = React__default.useState(shouldReadCache ? config_1.cacheGet(keyErr) : undefined);
      // if there's any ongoing request
      let [isValidating, setIsValidating] = React__default.useState(false);
      // error ref inside revalidate (is last request errored?)
      const unmountedRef = React__default.useRef(false);
      const keyRef = React__default.useRef(key);
      const errorRef = React__default.useRef(error);
      const dataRef = React__default.useRef(data);
      // start a revalidation
      const revalidate = React__default.useCallback(async (revalidateOpts = {}) => {
          if (!key)
              return false;
          ...
          let loading = true;
          let shouldDeduping = typeof config_1.CONCURRENT_PROMISES[key] !== 'undefined' && revalidateOpts.dedupe;
          // start fetching
          try {
              ...
              if (shouldDeduping) {
                  ...
                  startAt = config_1.CONCURRENT_PROMISES_TS[key];
                  newData = await config_1.CONCURRENT_PROMISES[key];
              }
              else {
                  // if no cache being rendered currently (it shows a blank page),
                  // we trigger the loading slow event.
                  if (config.loadingTimeout && !config_1.cacheGet(key)) {
                      setTimeout(() => {
                          if (loading)
              ...
              if (config_1.MUTATION_TS[key] && startAt <= config_1.MUTATION_TS[key]) {
                  setIsValidating(false);
                  return false;
              }
              config_1.cacheSet(key, newData);
              config_1.cacheSet(keyErr, undefined);
              keyRef.current = key;
              // batch state updates
              reactBatchedUpdates.unstable_batchedUpdates(() => {
                  ...
                  if (fast_deep_equal_1.default(dataRef.current, newData)) {
      ...
      const useIsomorphicLayoutEffect = IS_SERVER ? React__default.useEffect : React__default.useLayoutEffect;
      ...
      useIsomorphicLayoutEffect(() => {
          ...
          const latestKeyedData = config_1.cacheGet(key);
          // update the state if the key changed or cache updated
          if (keyRef.current !== key ||
              !fast_deep_equal_1.default(currentHookData, latestKeyedData)) {
          ...
          if (config.revalidateOnFocus) {
              ...
              onFocus = throttle_1$1.default(softRevalidate, config.focusThrottleInterval);
          ...
          const onUpdate = (shouldRevalidate = true, updatedData, updatedError) => {
              ...
              reactBatchedUpdates.unstable_batchedUpdates(() => {
                  if (typeof updatedData !== 'undefined' &&
                      !fast_deep_equal_1.default(dataRef.current, updatedData)) {
                      setData(updatedData);
          ...
          return () => {
              ...
              if (onFocus && config_1.FOCUS_REVALIDATORS[key]) {
      ...
      if (config.suspense) {
          ...
          let latestData = config_1.cacheGet(key);
          let latestError = config_1.cacheGet(keyErr);
          if (typeof latestData === 'undefined' &&
              ...
              if (config_1.CONCURRENT_PROMISES[key] &&
                  typeof config_1.CONCURRENT_PROMISES[key].then === 'function') {
                  // if it is a promise
                  throw config_1.CONCURRENT_PROMISES[key];
              }
              // it's a value, return it directly (override)
              latestData = config_1.CONCURRENT_PROMISES[key];
          }
  ...
  unwrapExports(useSwr);
  var useSwr_1 = useSwr.trigger;
  var useSwr_2 = useSwr.mutate;
  var useSwr_3 = useSwr.SWRConfig;

  var useSwrPages = createCommonjsModule(function (module, exports) {
  var __importStar = (commonjsGlobal && commonjsGlobal.__importStar) || function (mod) {
      if (mod && mod.__esModule) return mod;
      var result = {};
      if (mod != null) for (var k in mod) if (Object.hasOwnProperty.call(mod, k)) result[k] = mod[k];
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  const react_1 = __importStar(React__default);
  ...
  */
  function useSWRPages(pageKey, pageFn, SWRToOffset, deps = []) {
      ...
      const [pageCount, setPageCount] = react_1.useState(config.cacheGet(pageCountKey) || 1);
      const [pageOffsets, setPageOffsets] = react_1.useState(config.cacheGet(pageOffsetKey) || [null]);
      const [pageSWRs, setPageSWRs] = react_1.useState([]);
      const pageCacheRef = react_1.useRef([]);
      const pageFnRef = react_1.useRef(pageFn);
      const emptyPageRef = react_1.useRef(false);
      // Page component (wraps `pageFn`)
      // for performance reason we need to memorize it
      const Page = react_1.useCallback(props => {
      ...
      const loadMore = react_1.useCallback(() => {
          if (isLoadingMore || isReachingEnd)
              return;
          setPageCount(c => {
              config.cacheSet(pageCountKey, c + 1);
              return c + 1;
          });
      }, [isLoadingMore || isReachingEnd]);
      const _pageFn = react_1.useCallback(pageFn, deps);
      pageFnRef.current = _pageFn;
      const pages = react_1.useMemo(() => {
                  ...
                  if (typeof swr.data !== 'undefined') {
                      ...
                      if (pageOffsets[id + 1] !== newPageOffset) {
                          setPageOffsets(arr => {
                              ...
                              config.cacheSet(pageOffsetKey, _arr);
                              return _arr;
                          });
                      }
                  }
          ...
          for (let i = 0; i < pageCount; ++i) {
              if (!pageCache[i] ||
                  ...
                  pageCache[i] = {
                      component: (react_1.default.createElement(Page, { key: `page-${pageOffsets[i]}-${i}`, offset: pageOffsets[i], withSWR: getWithSWR(i) })),
                      pageFn: _pageFn,
  ...
  exports.useSWRPages = useSWRPages;
  });

  unwrapExports(useSwrPages);
  var useSwrPages_1 = useSwrPages.useSWRPages;
  ...
  Object.defineProperty(exports, "__esModule", { value: true });
  __export(useSwr);
  const use_swr_1 = __importDefault(useSwr);

  exports.useSWRPages = useSwrPages.useSWRPages;
  exports.default = use_swr_1.default;
  });

  var useSWR = unwrapExports(dist);
  var dist_1 = dist.useSWRPages;
  ...
  var DailyReport = function DailyReport(props) {
    ...
    var _useSWR = useSWR('zaobao.list', function _callee() {
      var _ref, data;
    ...
    useEffect$1(function () {
      event.on(MESSAGES$1.CHANGE_DAILY_ID, changeCurrentId);
      return function () {
        event.off(MESSAGES$1.CHANGE_DAILY_ID, changeCurrentId);
      };
    }, []);

    var _useSWR2 = useSWR(function () {
      return "zaobao.list.detail.".concat(currentId);
    }, function _callee2(query) {
      var id, _ref2, _data;
    ...
    var LoadMore = size < length && React.createElement("div", {
      ...
      className: styles$2.more,
      onClick: handleLoadMore
    }, formatMessage({
      id: 'org.umi.ui.dashboard.card.zaobao.loadMore'
    })));

    var getTagCls = function getTagCls(name) {
      return classnames(styles$2['listItem-meta-tag'], _defineProperty({}, styles$2["listItem-meta-tag-".concat(TAG_MAP[name] || TAG_MAP.Star)], !!name));
    };
    ...
    return React.createElement(antd.List, {
      ...
      loadMore: LoadMore,
      renderItem: function renderItem(item) {
        return _.isPlainObject(item) && React.createElement(antd.List.Item, {
          className: styles$2.listItem
        }, React.createElement(antd.List.Item.Meta, {
          className: styles$2['listItem-meta'],
          title: React.createElement("a", {
            target: "_blank",
            rel: "noopener noreferrer",
            href: item.href
          }, React.createElement(Paragraph$1, {
            className: styles$2.paragraph,
            ellipsis: true
          }, item.title), ' ', React.createElement(antd.Tag, {
  ...
  var DailyReportHeader = function DailyReportHeader(props) {
    ...
    var handleOnChange = function handleOnChange(value) {
      event.emit(MESSAGES$1.CHANGE_DAILY_ID, value);
    };

    return React.createElement("div", {
      className: styles$2['select-wrapper']
    }, Array.isArray(list) && React.createElement(antd.Select, {
  ...
  var ui = (function (api) {
    ...
    api.addDashboard({
      ...
      title: React__default.createElement(DailyReportTitle, null),
      ...
      right: React__default.createElement(DailyReportHeader, null),
      span: {
        xl: 12
      },
      content: React__default.createElement(DailyReport, null)
    });
    api.addPanel({
      title: 'org.umi.ui.dashboard.panel',
      path: '/dashboard',
      actions: [React__default.createElement(Layout, {
        api: api
      }, React__default.createElement(ConfigAction, null))],
      icon: {
        type: 'dashboard',
        theme: 'filled'
      },
      component: function component() {
        return React__default.createElement(Layout, {
          api: api
        }, React__default.createElement(DashboardUI, null));
      }
    });
  });
