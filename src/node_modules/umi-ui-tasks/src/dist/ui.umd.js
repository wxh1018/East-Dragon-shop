(function (global, factory) {
  ...
  */
  ...
  var VerticalAlignBottomOutline_1 = createCommonjsModule(function (module, exports) {
  Object.defineProperty(exports, "__esModule", { value: true });
  ...
  exports.default = VerticalAlignBottomOutline;
  });

  var VerticalAlignBottomOutlineSvg = unwrapExports(VerticalAlignBottomOutline_1);

  // GENERATE BY ./scripts/generateIcons.js

  var VerticalAlignBottom = function VerticalAlignBottom(props) {
    return React$1__default.createElement(Icon, Object.assign({}, props, {
      icon: VerticalAlignBottomOutlineSvg
    }));
  };
  ...
  */
  ...
  function initTerminal() {
    ...
    terminal.loadAddon(new xtermAddonFit_1());
    return terminal;
  }
  ...
  var getTerminalIns = function getTerminalIns(taskType, key) {
    if (!key || !taskType) {
      return null;
    }
  ...
  var useTerminal = function useTerminal(_ref) {
    var terminal = _ref.terminal,
        container = _ref.ref;
    var fitAddon = new xtermAddonFit_1();
    React$1.useEffect(function () {
      if (!container) {
        return;
      }
  ...
  var TerminalComponent = function TerminalComponent(_ref) {
    ...
    var _useTerminal = useTerminal({
      terminal: terminal,
      ref: domContainer.current
    }),
        fitAddon = _useTerminal.fitAddon;
    ...
    }, React$1__default.createElement(VerticalAlignBottom, {
      onClick: toBottom
        ...
        return regeneratorRuntime.wrap(function writeLog$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 9:
                ins = getTerminalIns(taskType, projectKey);
  ...
  var DevComponent = function DevComponent(_ref) {
    ...
    React$1.useEffect(function () {
      ...
      return function () {
        form.resetFields();
        var terminal = getTerminalIns(taskType, api.currentProject.key);
  ...
  var BuildComponent = function BuildComponent(_ref) {
    ...
    React$1.useEffect(function () {
      ...
      return function () {
        form.resetFields();
        var terminal = getTerminalIns(taskType$1, api.currentProject.key);
        terminal && terminal.clear();
      };
    }, [init, view, iife]);
    ...
    return React$1__default.createElement(React$1__default.Fragment, null, React$1__default.createElement("h1", {
      ...
      return view === 'log' ? React$1__default.createElement(TerminalComponent, {
        api: api,
        size: size,
        terminal: getTerminalIns(taskType$1, api.currentProject.key),
        log: log,
        onClear: function onClear() {
          clearLog(taskType$1);
        }
  ...
  var LintComponent = function LintComponent(_ref) {
    ...
    React$1.useEffect(function () {
      ...
      return function () {
        var terminal = getTerminalIns(taskType$2, api.currentProject.key);
        terminal && terminal.clear();
      };
    }, [init, iife]);
    ...
    return React$1__default.createElement(React$1__default.Fragment, null, React$1__default.createElement("h1", {
      ...
      return React$1__default.createElement(TerminalComponent, {
        api: api,
        size: size,
        terminal: getTerminalIns(taskType$2, api.currentProject.key),
        log: log,
        onClear: function onClear() {
          clearLog(taskType$2);
        }
  ...
  var TestComponent = function TestComponent(_ref) {
    ...
    React$1.useEffect(function () {
      ...
      return function () {
        var terminal = getTerminalIns(taskType$3, api.currentProject.key);
        terminal && terminal.clear();
      };
    }, [init]);
    ...
    return React$1__default.createElement(React$1__default.Fragment, null, React$1__default.createElement("h1", {
      ...
      return React$1__default.createElement(TerminalComponent, {
        api: api,
        size: size,
        terminal: getTerminalIns(taskType$3, api.currentProject.key),
        log: log,
        onClear: function onClear() {
          clearLog(taskType$3);
        }
  ...
  var InstallComponent = function InstallComponent(_ref) {
    ...
    React$1.useEffect(function () {
      return function () {
        form.resetFields();
        var terminal = getTerminalIns(taskType$4, api.currentProject.key);
        terminal && terminal.clear();
      };
    }, []);
    ...
    return React$1__default.createElement(React$1__default.Fragment, null, React$1__default.createElement("h1", {
      ...
      return React$1__default.createElement(TerminalComponent, {
        api: api,
        size: size,
        terminal: getTerminalIns(taskType$4, api.currentProject.key),
        log: log,
        onClear: function onClear() {
          clearLog(taskType$4);
        }
  ...
  var ui = (function (api) {
    ...
    api.addDashboard({
      ...
      icon: React$1__default.createElement(Setting, null),
      content: [React$1__default.createElement("a", {
